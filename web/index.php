...
<!--                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>-->
                    ...
                    <div class="modal-body">
                        <p>Este juego pretende ayudar enseñando a leer a los niñ@s.</p>
                        <p>Se ofrece sin ningún tipo de garantía, y su uso es responsabilidad exclusiva de los tutores legales del niñ@. Por lo que es recomendable que lo usen antes que el menor para asegurarse que es adecuado.</p>
                        ...
                        <p><strong>Importante</strong>: El reconocimiento de voz puede que se procese en la nube, dependerá del navegador. Lo que significa que la voz será enviada al proveedor del navegador, no encontré indicios de que se use para otra cosa, pero no puedo asegurarlo.</p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <il class="list-group-item">Gráficos:
                                <ul>
                            ...
                            <il class="list-group-item">Fuente cursiva: <a href="https://fonts.google.com/share?selection.family=Gochi%20Hand" rel="nofollow" target="_blank">Gochi Hand by Juan Pablo del Peral for Huerta Tipográfica.</a></il>
                        </ul>
                    </div>
                    <div class="modal-footer">
